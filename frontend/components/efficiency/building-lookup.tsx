...
import { Building2, DollarSign, Search, TrendingUp } from "lucide-react"
...
export default function BuildingLookup() {
  const [buildingId, setBuildingId] = useState<string>("")
  const [activeTab, setActiveTab] = useState("summary")

  const form = useForm<{ building_id: string }>({
  ...
  const onSubmit = (data: { building_id: string }) => {
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Enter a building ID to view efficiency calculations and performance
            metrics
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <Card>
              <CardContent className="py-8">
                <div className="text-center text-red-600">
                  <p>
                    Error loading building data. Please check the building ID
                    and try again.
                  </p>
                </div>
              </CardContent>
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <div>
                          ...
                          <p className="text-2xl font-bold">
                            {buildingSummaryData.best_performance_grade ||
                              "N/A"}
                          </p>
                        </div>
                      </div>
                  ...
                  <div className="space-y-4">
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>
                          {buildingCalculationsData.total_count} calculations
                          found
                        </CardDescription>
                      </CardHeader>
                    </Card>
